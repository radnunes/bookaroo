<div class="container p-1">
    <div class="row px-0"> <!-- Removed padding from row -->
        <div class="col-md-12">
            <div class="card custom-card">
                <div class="card-body text-center p-2 bg-light rounded">
                    ...
                    @else
                        <img src="{{ asset('storage/images/' . $book->image_name . '.'. $book->image_type) }}" alt="{{ $book->title }}" class="card-img-top img-fluid rounded" style="max-width: 170px; max-height: 200px; width: auto; height: auto;">
                    @endif
